...
use Andatech\Passport\Client;
use PHPUnit\Framework\TestCase;
use Andatech\Passport\TokenRepository;
use Andatech\Passport\Http\Controllers\AuthorizedAccessTokenController;
...
class AuthorizedAccessTokenControllerTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->controller = new Andatech\Passport\Http\Controllers\AuthorizedAccessTokenController(
    ...
    public function test_tokens_can_be_retrieved_for_users()
    {
        ...
        $token1 = new Andatech\Passport\Token;
        $token2 = new Andatech\Passport\Token;
    ...
    public function test_tokens_can_be_deleted()
    {
        ...
        $token1 = Mockery::mock(Andatech\Passport\Token::class.'[revoke]');
        $token1->id = 1;
