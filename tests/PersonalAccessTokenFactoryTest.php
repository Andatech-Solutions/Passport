...
class PersonalAccessTokenFactoryTest extends TestCase
{
    ...
    public function test_access_token_can_be_created()
    {
        ...
        $factory = new Andatech\Passport\PersonalAccessTokenFactory($server, $clients, $tokens, $jwt);
        ...
        $this->assertInstanceOf('Andatech\Passport\PersonalAccessTokenResult', $result);
    }
}
...
class PersonalAccessTokenFactoryTestModelStub extends Andatech\Passport\Token
{
    public $id = 1;
    public $secret = 'something';
}
