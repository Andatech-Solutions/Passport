...
class TransientTokenControllerTest extends TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('Andatech\Passport\ApiTokenCookieFactory');
        ...
        $controller = new Andatech\Passport\Http\Controllers\TransientTokenController($cookieFactory);
