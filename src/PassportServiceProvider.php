...
use Andatech\Passport\Guards\TokenGuard;
...
use Andatech\Passport\Bridge\PersonalAccessGrant;
use League\OAuth2\Server\Grant\RefreshTokenGrant;
use Andatech\Passport\Bridge\RefreshTokenRepository;
...
class PassportServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                __DIR__.'/../Andatech/Passport' => base_path('app/Andatech/Passport'),
